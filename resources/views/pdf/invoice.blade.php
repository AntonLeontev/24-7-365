...
<head>
	...
	* {font-family: 'DejaVu Sans';font-size: 14px;line-height: 14px;}
	...
	.disclaimer-header {margin-bottom: 10px; font-size: 18px; font-weight: bold;}
	</style>
</head>
<body>
	...
	<div class="disclaimer">
		<div class="disclaimer-header">Дисклеймер</div>
		<div>
			Обращаем ваше внимание, что назначение платежа вашего платежного поручения должно ТОЧНО СООТВЕТСТВОВАТЬ следующему тексту (нужно скопировать):
		</div>
		<div style="margin: 10px 0; font-style: bold">{{ $payment->description }}</div>
		<div>
			В противном случае, вынуждены будем вам вернуть ваш платеж. Расходы на возврат средств на ваш р/с (банковская комиссия / от 1 до 3%), в таком случае, будет произведен за ваш счет.
		</div>
	</div>
</body>
</html>
