<header class="border-bottom top-header-bottom px-xxl-110 px-xxxl-120">
	<div class="container-fluid">
		<div class="row align-items-center top-header">
			...
			<div class="align-center top-greetings-main-right-col col-auto text-end">
				<p class="mb-0">Нет новых уведомлений</p>
				<p class="mb-0 text-primary">Уведомления</p>
			</div>
	
			<div class="align-center top-notifications col-auto">
