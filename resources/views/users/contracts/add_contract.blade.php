        ...
        <div class="row">
            ...
            <div id="tariffs">
                                ...
                                <div class="col-4 mt-5">
                                    <div class="card" style="width: 18rem;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">
                                                Объем вклада:
                                                {{ $tariff->max_amount->raw() == 0 ? 'без ограничений' : 'до ' . $tariff->max_amount }}
                                                <br>
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item">доходность
                                                {{ $tariff->getting_profit == 1 ? 'ежемесячно' : 'по истечению срока' }}
                                            </li>
                                            <li class="list-group-item">тело вклада
                                                {{ $tariff->getting_deposit == 1 ? 'ежемесячно' : 'по истечению срока' }}
                                            </li>
                                        </ul>
                                        <div class="card-body">
                                            <a class="card-link" href="#calculator"
                                                @click="setCalcData({{ $tariff->annual_rate }},{{ $tariff->duration }},'{{ $tariff->title }}', {{ $tariff->id }})">Выбрать</a>
                ...
                <div id="calculator">
                    ...
                    <div class="container text-center">
                        <div class="row">
                            <table class="table text-center">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row"><input class="form-control" type="number"
                                                aria-label="default input example" v-model="amount" placeholder="Вклад">
                                        </th>
                    ...
                    <div class="container">
                        <form class="col" id="contract-form" action="{{ route('contracts.store') }}" method="post">
							@csrf
                            <input name="tariff_id" type="hidden" :value="tariffId">
                            <input name="amount" type="hidden" :value="amount">
                            <button class="btn btn-primary">Оформить договор</button>
							@error('tariff_id')
								{{ $message }}
							@enderror
							@error('amount')
